...
class Recorder {
  ...
  _setup() {
    ...
    if (!options) {
      throw new Error(
        `none of the codecs: ${commonCodecs.join(",")} are supporteds`
      );
    }
  ...
  startRecording() {
    ...
    console.log(
      `Created media recorded ${this.mediaRecorder} with options ${options}`
    );
    ...
    console.log("Media Recorded Starde", this.mediaRecorder);
